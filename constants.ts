...
export const MIC_INITIAL_GAIN = 0.8;
export const MIC_TARGET_AVERAGE_VOLUME = 40; // Target average volume (0-255 scale) for post-gain data
export const MIC_MIN_GAIN = 0.2;             // Minimum gain multiplier
export const MIC_MAX_GAIN = 2.5;             // Maximum gain multiplier (be careful with very high values)
